...
const partners = [
  {
    ...
    description:
      "This partnership tier is currently available for qualifying ER:LC communities seeking cross-network visibility.",
    members: "Open Slot",
  ...
  },
  {
    ...
    description:
      "Reserved for upcoming tactical networks and dispatch coordination hubs looking to feature EventHub integration.",
    members: "Open Slot",
    category: "Available Slot",
    invite: "https://discord.gg/J3Dv735xg",
  },
  {
    ...
    description:
      "Open listing for high-activity roleplay servers interested in official co-promotion and automated event tooling.",
    members: "Open Slot",
    category: "Available Slot",
    invite: "https://discord.gg/J3Dv735xg",
  },
    ...
    <div className="max-w-6xl mx-auto pt-28 md:pt-32 pb-16 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="text-gray-400 mt-4 text-base md:text-lg">
          Explore our trusted partner communities and networks that power elite
          ER:LC roleplay alongside EventHub.
        </p>
      </div>
          ...
          return (
            ...
            >
              <div>
                ...
                <h3 className="text-xl font-bold text-white group-hover:text-indigo-300 transition-colors font-mono">
                  {partner.name}
                </h3>
      ...
      >
        <div className="space-y-2 text-center md:text-left">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-white">
            Want to list your community here?
          </h2>
          <p className="text-slate-300 text-sm max-w-xl">
            We are always looking to partner with active ER:LC communities. Join
            our support server to submit your partnership request.
          </p>
        </div>
        <div>
          <a
