...
const eventsData = [
  {
    ...
    description:
      "An immersive deduction and survival game mode for ER:LC roleplay servers.",
    sections: {
      logic:
        "Players are randomly assigned secret roles: Innocent, Sheriff, or Murderer. Innocents must survive and complete tasks around the map, the Sheriff must protect innocents and neutralize the threat, and the Murderer must eliminate all players without getting caught.",
      commands:
        "!startmm, !stopmm, !role assign [user] [role], !reveal murderer, !status",
      hints:
        "Listen closely for gunshot audio cues. Check dark corners and use proximity chat carefully to avoid being ambushed.",
      walkthrough:
        "1. Lobby opens and roles are secretly assigned to all participants.\n2. Round begins with a 30-second preparation and grace period.\n3. Murderer targets players; eliminated players drop bodies that can be reported by Innocents.\n4. Emergency meetings or direct shootouts determine the winning faction.",
    },
  },
  {
    id: "airsoft",
    ...
    title: "Airsoft",
    description:
      "Tactical simulation event utilizing non-lethal roleplay mechanics and team coordination.",
    sections: {
      logic:
        "Two opposing teams (Alpha and Bravo) compete in objective-based tactical skirmishes using designated airsoft loadouts, cover protocols, and single-side stacking tactics.",
      commands:
        "!startairsoft, !stopairsoft, !score, !loadout [team], !respawn [user]",
      hints:
        "Maintain constant radio discipline. Utilize tactical smoke granades and flashbangs to breach rooms securely.",
      walkthrough:
        "1. Teams gather at designated staging areas for equipment checks.\n2. Safety briefing and weapon safety verification are completed.\n3. Match starts with objective capture zones activated across the map.\n4. First team to secure all tactical control points wins the match.",
    },
  },
  {
    id: "car-show",
    ...
    title: "Car Show",
    description:
      "Showcase custom vehicle builds, liveries, and performance tuning in a regulated meetup environment.",
    sections: {
      logic:
        "Participants park their custom vehicles in designated exhibition slots while judges and community members evaluate styling, wheel choice, paint finish, and theme authenticity.",
      commands:
        "!startcarshow, !vote [id], !results, !spawncar [slot], !lockcars",
      hints:
        "Maintain safe driving speeds in the exhibition zone. Respect other participants custom vehicle builds at all times.",
      walkthrough:
        "1. Vehicle registration and staging in the designated pit area.\n2. Controlled sequential entry into the main exhibition showcase pavilion.\n3. Public voting window and professional judge inspection phase.\n4. Trophy ceremony and organized cruise convoy departure.",
    },
  },
  {
    id: "circuit-race",
    ...
    title: "Circuit Race",
    description:
      "High-speed professional track racing event with automated checkpoint validation and lap timing.",
    sections: {
      logic:
        "Racers complete a set number of laps around a sanctioned circuit track while avoiding traffic, managing tire wear, and navigating tight chicanes and hairpins.",
      commands:
        "!startrace, !lap [user], !leaderboard, !finishline, !disqualify [user]",
      hints:
        "Watch your braking zones on sharp corners. Intentional ramming will result in immediate disqualification from the race grid.",
      walkthrough:
        "1. Grid lineup based on qualifying times or random draw.\n2. Countdown timer starts with synchronized visual traffic lights.\n3. Multi-lap high-speed sprint across the official circuit layout.\n4. Podium celebration and trophy handover for top 3 finishers.",
    },
  },
];
    ...
    <div className="max-w-6xl mx-auto pt-28 md:pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      >
        ...
        <p className="text-slate-400 mt-4 text-base md:text-lg">
          Explore game logic, bot commands, hints, and full round walkthroughs
          for all official ER:LC events.
        </p>
      </div>
        ...
        <div className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 min-h-[220px] flex flex-col justify-between backdrop-blur-md">
          <div>
            <h3 className="text-sm font-mono text-indigo-400 uppercase tracking-wider mb-3">
              {activeTab === "logic" &&
                `${current.number}.1 Game Logic Overview`}
              {activeTab === "commands" &&
                `${current.number}.2 Bot & Game Commands`}
              {activeTab === "hints" &&
                `${current.number}.3 Hints & Broadcast Messages`}
              {activeTab === "walkthrough" &&
                `${current.number}.4 Full Round Walkthrough`}
            </h3>
          ...
          <div className="mt-8 pt-4 border-t border-slate-800 flex items-center justify-between text-xs text-slate-500 font-mono">
            ...
            <span className="text-indigo-400">
              EventHub Automated Dispatch v2.4
            </span>
          </div>
        </div>
      </div>
